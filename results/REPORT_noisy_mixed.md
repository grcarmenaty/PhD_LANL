...
| xgb         | `cfdac_imag` | 0.984 | 0.982 | 0.941 |
| rf          | `cfdac_imag` | 0.982 | 0.982 | 0.941 |
| rf          | `cfdac_phase` | 0.979 | 0.980 | 0.941 |
| xgb         | `cfdac_real` | 0.975 | 0.977 | 0.941 |
| cnn2d       | `cfdac` | 0.971 | 0.975 | 0.879 |
| cnn2d       | `cfdac_real` | 0.974 | 0.975 | 0.907 |
| cnn2d       | `cfdac_imag` | 0.970 | 0.973 | — |
| rf          | `cfdac_real` | 0.956 | 0.959 | 0.940 |
| xgb         | `cfdac_mag` | 0.954 | 0.958 | 0.941 |
| cnn2d       | `cfdac_magphase` | 0.953 | 0.957 | 0.856 |
| transformer | `cfdac_realimag` | 0.957 | 0.956 | — |
| transformer | `cfdac_imag` | 0.957 | 0.956 | — |
| cnn2d       | `cfdac_phase` | 0.952 | 0.953 | 0.846 |
| mlp         | `cfdac_imag` | 0.950 | 0.949 | 0.871 |
| cnn         | `timeseries` | 0.946 | 0.949 | 0.928 |
| cnn         | `cfdac_imag` | 0.946 | 0.949 | — |
| transformer | `timeseries` | 0.947 | 0.948 | 0.931 |
| cnn         | `cfdac_phase` | 0.942 | 0.944 | — |
| cnn         | `cfdac_all` | 0.940 | 0.943 | — |
| cnn         | `cfdac_realimag` | 0.937 | 0.941 | — |
| cnn         | `cfdac_real` | 0.932 | 0.934 | — |
| transformer | `cfdac_real` | 0.926 | 0.932 | — |
| rf          | `cfdac_mag` | 0.925 | 0.930 | 0.890 |
| xgb         | `modal` | 0.928 | 0.929 | 0.941 |
| cnn         | `cfdac_magphase` | 0.922 | 0.927 | — |
| mlp         | `cfdac_phase` | 0.922 | 0.923 | 0.940 |
| mlp         | `cfdac_realimag` | 0.905 | 0.919 | 0.941 |
| transformer | `frf_mag` | 0.913 | 0.914 | 0.934 |
| mlp         | `modal` | 0.910 | 0.913 | 0.941 |
| transformer | `cfdac_magphase` | 0.912 | 0.910 | — |
| transformer | `cfdac_phase` | 0.904 | 0.906 | — |
| mlp         | `cfdac_all` | 0.888 | 0.894 | 0.941 |
| rf          | `modal` | 0.885 | 0.892 | 0.941 |
| transformer | `cfdac_all` | 0.881 | 0.884 | — |
| mlp         | `cfdac_magphase` | 0.881 | 0.883 | 0.940 |
| cnn2d       | `cfdac_mag` | 0.865 | 0.875 | 0.941 |
| cnn         | `frf_mag` | 0.861 | 0.864 | 0.832 |
| cnn         | `cfdac_mag` | 0.836 | 0.846 | — |
| mlp         | `cfdac_real` | 0.816 | 0.814 | 0.941 |
| mlp         | `cfdac_mag` | 0.800 | 0.800 | 0.941 |
...
| rf          | `cfdac_imag` | 0.944 | 0.949 | 0.284 |
| rf          | `cfdac_real` | 0.911 | 0.920 | 0.374 |
| rf          | `cfdac_mag` | 0.867 | 0.870 | 0.385 |
| cnn2d       | `cfdac` | 0.850 | 0.858 | 0.338 |
| cnn2d       | `cfdac_imag` | 0.850 | 0.857 | 0.256 |
| mlp         | `cfdac_imag` | 0.851 | 0.857 | 0.310 |
| cnn2d       | `cfdac_real` | 0.849 | 0.853 | 0.315 |
| cnn2d       | `cfdac_phase` | 0.838 | 0.844 | 0.272 |
| transformer | `cfdac_realimag` | 0.836 | 0.842 | — |
| xgb         | `modal` | 0.836 | 0.842 | 0.200 |
| transformer | `cfdac_imag` | 0.824 | 0.832 | — |
| cnn2d       | `cfdac_magphase` | 0.825 | 0.832 | 0.334 |
| transformer | `frf_mag` | 0.815 | 0.824 | 0.324 |
| cnn         | `cfdac_real` | 0.810 | 0.820 | — |
| cnn         | `cfdac_realimag` | 0.808 | 0.816 | — |
| cnn         | `cfdac_imag` | 0.808 | 0.814 | — |
| transformer | `cfdac_real` | 0.805 | 0.812 | — |
| mlp         | `cfdac_realimag` | 0.806 | 0.811 | 0.375 |
| cnn         | `cfdac_all` | 0.799 | 0.807 | — |
| mlp         | `cfdac_real` | 0.794 | 0.799 | 0.363 |
| mlp         | `cfdac_phase` | 0.800 | 0.798 | 0.235 |
| rf          | `modal` | 0.791 | 0.798 | 0.250 |
| mlp         | `modal` | 0.785 | 0.797 | 0.235 |
| cnn         | `cfdac_phase` | 0.782 | 0.793 | — |
| cnn         | `cfdac_magphase` | 0.787 | 0.789 | — |
| cnn         | `timeseries` | 0.784 | 0.788 | 0.316 |
| transformer | `cfdac_phase` | 0.772 | 0.775 | — |
| transformer | `timeseries` | 0.773 | 0.774 | 0.322 |
| transformer | `cfdac_all` | 0.771 | 0.767 | — |
| mlp         | `cfdac_magphase` | 0.754 | 0.759 | 0.272 |
| cnn2d       | `cfdac_mag` | 0.761 | 0.759 | 0.268 |
| transformer | `cfdac_magphase` | 0.753 | 0.755 | — |
| mlp         | `cfdac_all` | 0.741 | 0.741 | 0.290 |
| cnn         | `frf_mag` | 0.737 | 0.737 | 0.260 |
| cnn         | `cfdac_mag` | 0.713 | 0.709 | — |
| transformer | `cfdac_mag` | 0.609 | 0.616 | — |
...
| xgb         | `cfdac_phase` | 0.712 | 0.711 | -0.057 |
| xgb         | `cfdac_real` | 0.687 | 0.690 | -0.000 |
| xgb         | `modal` | 0.642 | 0.645 | -0.600 |
| xgb         | `cfdac_mag` | 0.637 | 0.635 | -0.009 |
| cnn2d       | `cfdac_imag` | 0.614 | 0.598 | -1.099 |
| rf          | `modal` | 0.588 | 0.588 | -0.274 |
| cnn2d       | `cfdac` | 0.606 | 0.587 | -0.785 |
| cnn2d       | `cfdac_real` | 0.590 | 0.569 | -0.468 |
| cnn         | `cfdac_all` | 0.550 | 0.549 | — |
| cnn2d       | `cfdac_phase` | 0.555 | 0.548 | -0.234 |
| cnn         | `cfdac_phase` | 0.562 | 0.545 | — |
| cnn         | `cfdac_magphase` | 0.545 | 0.542 | — |
| cnn         | `cfdac_imag` | 0.548 | 0.542 | — |
| mlp         | `cfdac_phase` | 0.542 | 0.539 | -0.270 |
| cnn2d       | `cfdac_magphase` | 0.560 | 0.538 | -0.341 |
| cnn         | `cfdac_realimag` | 0.534 | 0.522 | — |
| mlp         | `modal` | 0.543 | 0.520 | -2.897 |
| mlp         | `cfdac_imag` | 0.530 | 0.518 | -0.527 |
| mlp         | `cfdac_magphase` | 0.499 | 0.488 | -0.102 |
| cnn         | `cfdac_real` | 0.490 | 0.480 | — |
| cnn         | `timeseries` | 0.462 | 0.447 | -9.432 |
| mlp         | `cfdac_all` | 0.459 | 0.446 | -0.041 |
| transformer | `timeseries` | 0.445 | 0.431 | -0.333 |
| cnn         | `frf_mag` | 0.330 | 0.336 | -25.913 |
| mlp         | `cfdac_realimag` | 0.326 | 0.335 | -0.053 |
| mlp         | `cfdac_real` | 0.294 | 0.306 | -0.166 |
| transformer | `frf_mag` | 0.245 | 0.254 | -0.105 |
| cnn2d       | `cfdac_mag` | 0.253 | 0.250 | -0.549 |
| mlp         | `cfdac_mag` | 0.193 | 0.193 | -0.387 |
...
| rf          | `cfdac_imag` | 0.889 | 0.886 | 0.140 |
| rf          | `cfdac_real` | 0.851 | 0.848 | 0.202 |
| rf          | `cfdac_mag` | 0.829 | 0.833 | 0.237 |
| xgb         | `modal` | 0.817 | 0.810 | 0.242 |
| rf          | `modal` | 0.784 | 0.776 | 0.065 |
| mlp         | `cfdac_imag` | 0.524 | 0.519 | 0.231 |
| cnn         | `cfdac_magphase` | 0.510 | 0.516 | — |
| cnn         | `cfdac_phase` | 0.517 | 0.515 | — |
| cnn2d       | `cfdac_real` | 0.504 | 0.514 | 0.131 |
| cnn2d       | `cfdac_phase` | 0.519 | 0.514 | 0.131 |
| transformer | `cfdac_phase` | 0.519 | 0.513 | — |
| transformer | `timeseries` | 0.506 | 0.510 | 0.192 |
| transformer | `cfdac_all` | 0.503 | 0.507 | — |
| transformer | `frf_mag` | 0.515 | 0.507 | 0.106 |
| cnn2d       | `cfdac_imag` | 0.510 | 0.506 | 0.108 |
| cnn         | `timeseries` | 0.506 | 0.503 | 0.225 |
| cnn         | `cfdac_imag` | 0.498 | 0.502 | — |
| mlp         | `modal` | 0.504 | 0.502 | 0.231 |
| cnn2d       | `cfdac_magphase` | 0.520 | 0.501 | 0.125 |
| mlp         | `cfdac_realimag` | 0.501 | 0.501 | 0.215 |
| cnn2d       | `cfdac` | 0.512 | 0.500 | 0.108 |
| cnn         | `cfdac_all` | 0.510 | 0.500 | — |
| transformer | `cfdac_real` | 0.503 | 0.499 | — |
| mlp         | `cfdac_real` | 0.486 | 0.496 | 0.144 |
| mlp         | `cfdac_all` | 0.504 | 0.495 | 0.177 |
| transformer | `cfdac_magphase` | 0.502 | 0.493 | — |
| transformer | `cfdac_imag` | 0.491 | 0.493 | — |
| mlp         | `cfdac_phase` | 0.506 | 0.492 | 0.177 |
| cnn         | `cfdac_realimag` | 0.490 | 0.490 | — |
| mlp         | `cfdac_magphase` | 0.489 | 0.490 | 0.131 |
| mlp         | `cfdac_mag` | 0.490 | 0.489 | 0.179 |
| cnn         | `cfdac_mag` | 0.476 | 0.485 | — |
| cnn         | `frf_mag` | 0.484 | 0.484 | 0.192 |
| transformer | `cfdac_realimag` | 0.500 | 0.482 | — |
| cnn         | `cfdac_real` | 0.484 | 0.481 | — |
| cnn2d       | `cfdac_mag` | 0.491 | 0.477 | 0.000 |
...
| rf          | `cfdac_real` | 0.997 | 0.998 | 0.275 |
| xgb         | `modal` | 0.998 | 0.997 | 0.250 |
| rf          | `cfdac_phase` | 0.998 | 0.997 | 0.150 |
| rf          | `modal` | 0.996 | 0.993 | 0.425 |
| cnn         | `cfdac_all` | 0.991 | 0.992 | — |
| cnn         | `cfdac_magphase` | 0.989 | 0.992 | — |
| cnn         | `frf_mag` | 0.990 | 0.992 | 0.075 |
| cnn         | `timeseries` | 0.993 | 0.992 | 0.250 |
| mlp         | `modal` | 0.997 | 0.990 | 0.250 |
| mlp         | `cfdac_all` | 0.989 | 0.989 | 0.181 |
| mlp         | `cfdac_imag` | 0.985 | 0.988 | 0.250 |
| mlp         | `cfdac_magphase` | 0.986 | 0.988 | 0.113 |
| mlp         | `cfdac_phase` | 0.987 | 0.988 | 0.325 |
| cnn2d       | `cfdac` | 0.983 | 0.986 | 0.300 |
| cnn         | `cfdac_phase` | 0.988 | 0.984 | — |
| cnn2d       | `cfdac_phase` | 0.981 | 0.983 | 0.138 |
| cnn2d       | `cfdac_real` | 0.978 | 0.981 | 0.231 |
| cnn2d       | `cfdac_magphase` | 0.982 | 0.980 | 0.250 |
| cnn2d       | `cfdac_imag` | 0.977 | 0.979 | 0.325 |
| mlp         | `cfdac_realimag` | 0.978 | 0.979 | 0.075 |
| cnn         | `cfdac_imag` | 0.981 | 0.978 | — |
| transformer | `cfdac_all` | 0.977 | 0.976 | — |
| transformer | `frf_mag` | 0.985 | 0.976 | 0.250 |
| transformer | `cfdac_phase` | 0.964 | 0.975 | — |
| transformer | `cfdac_magphase` | 0.969 | 0.974 | — |
| rf          | `cfdac_mag` | 0.969 | 0.974 | 0.250 |
| mlp         | `cfdac_real` | 0.971 | 0.972 | 0.300 |
| cnn         | `cfdac_realimag` | 0.963 | 0.961 | — |
| transformer | `cfdac_imag` | 0.953 | 0.959 | — |
| transformer | `timeseries` | 0.964 | 0.958 | 0.013 |
| cnn         | `cfdac_real` | 0.945 | 0.946 | — |
| cnn         | `cfdac_mag` | 0.940 | 0.936 | — |
| mlp         | `cfdac_mag` | 0.935 | 0.928 | 0.250 |
| cnn2d       | `cfdac_mag` | 0.929 | 0.927 | 0.250 |
| transformer | `cfdac_realimag` | 0.886 | 0.903 | — |
| transformer | `cfdac_real` | 0.844 | 0.846 | — |
