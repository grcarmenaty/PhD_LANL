...
|---|---|---|---|---|---|
| `binary` | **+0.931** (`cnn2d`/`cfdac_all`) | **+0.933** (`cnn2d`/`cfdac_imag`) | **+0.933** (`cnn2d`/`cfdac_phase`) | **+0.938** (`cnn2d`/`cfdac`) | **+0.921** (`cnn2d`/`cfdac_phase`) |
| `type` | — | — | — | — | — |
| `severity` | — | — | — | — | — |
| `col_location` | — | — | — | — | — |
| `mass_location` | — | — | — | — | — |
...
| cnn2d | `cfdac_real` | +0.847 | +0.865 | +0.898 | +0.892 | — |
