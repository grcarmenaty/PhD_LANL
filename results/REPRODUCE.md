...
The two are compared head-to-head in `REPORT_COMPARISON.md`, generated by
`python ml_pipeline/build_comparison_report.py` (reads only the committed
distilled JSONs of both studies; no per-case archive or HDF5 needed).
